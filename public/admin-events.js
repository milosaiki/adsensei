...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vuejs_datepicker__ = __webpack_require__(296);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    createEvent: function createEvent() {
      ...
      axios.post('event/save', formData).then(function (_ref) {
        var data = _ref.data;

        console.log(data);
        if (data.success == 1) {
          _this.eventAddedSuccess = true;
          _this.addNewEventToTheList(data.event);
        } else {
          _this.eventAddedError = true;
        }
      });
    },
    ...
    getEvents: function getEvents() {
      ...
      axios.get('event/all').then(function (_ref2) {
        var data = _ref2.data;
    ...
    deleteEvent: function deleteEvent(id) {
      axios.post('event/delete', { 'eventId': id }).then(function (_ref3) {
        var data = _ref3.data;
    ...
    addNewEventToTheList: function addNewEventToTheList(event) {
      ...
      var eventListbody = document.getElementById('eventListbody');
    ...
    openEditForm: function openEditForm(id) {
      ...
      axios.get('event/get?id=' + id).then(function (_ref4) {
        var data = _ref4.data;

        _this3.event.id = data.id;
        _this3.event.date = data.eventDate;
        _this3.event.title = data.title;
        _this3.event.from = data.timeFrom;
        _this3.event.to = data.timeTo;
      });
    }
  },
...
var render = function() {
  ...
  return _c("div", { staticClass: "row events" }, [
    _c("div", { staticClass: "btn-holder" }, [
      _c(
        "a",
        {
          staticClass: "btn btn-primary",
          attrs: { href: "#", title: "Add new event" },
          on: {
            click: function($event) {
              $event.preventDefault()
              return _vm.openForm($event)
            }
          }
        },
    ...
    _vm._v(" "),
    _c("div", { staticClass: "event-left" }, [
      _c("h2", [_vm._v("Dogadjaji")]),
      _vm._v(" "),
      _c("table", { staticClass: "table" }, [
        ...
        _c(
          "tbody",
          { attrs: { id: "eventListbody" } },
          _vm._l(_vm.events, function(event) {
            return _c("tr", { key: event.id, attrs: { "data-id": event.id } }, [
              ...
              _vm._v(" "),
              _c("td", [_vm._v(_vm._s(_vm._f("formatdate")(event.eventDate)))]),
              _vm._v(" "),
              _c("td", [
                _c(
                  "a",
    ...
    _vm._v(" "),
    _vm.displayForm
      ? _c("div", { staticClass: "event-form event-form-holder" }, [
          _c("h2", [_vm._v("Novi dogadjaj")]),
          _vm._v(" "),
          _c("div", { staticClass: "messages-holder" }, [
            _vm.eventAddedSuccess
              ? _c(
                  "div",
                  {
          ...
          _c(
            "form",
            {
              ...
              attrs: { method: "POST", id: "#addEventForm" }
            },
            [
              ...
              _c("div", { staticClass: "row" }, [
                _c("div", { staticClass: "col" }, [
                  ...
                  _c("input", {
                    ...
                    attrs: {
                      type: "text",
                      placeholder: "Upisite vreme",
                      id: "from",
                      name: "from"
                    },
                    domProps: { value: _vm.time.from },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.time, "from", $event.target.value)
                      }
                    }
                  })
                ]),
                ...
                _c("div", { staticClass: "col" }, [
                  ...
                  _c("input", {
                    ...
                    domProps: { value: _vm.time.to },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.time, "to", $event.target.value)
                      }
                    }
                  })
                ])
    ...
    _vm.editFormOpen
      ? _c("div", { staticClass: "event-form event-form-holder" }, [
          _c("h2", [_vm._v("Izmeni dogadjaj")]),
          _vm._v(" "),
          _c("div", { staticClass: "messages-holder" }, [
            _vm.eventUpdateSuccess
              ? _c(
                  "div",
                  {
                    staticClass: "alert alert-success",
          ...
          _c(
            ...
            {
              staticClass: "event-form",
              attrs: { method: "POST", id: "#editEventForm" }
            },
            [
              _c("div", { staticClass: "form-group" }, [
                _c(
              ...
              _c("div", { staticClass: "row" }, [
                _c("div", { staticClass: "col" }, [
                  ...
                  _c("input", {
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.event.from,
                        expression: "event.from"
                      }
                    ],
                    staticClass: "form-control",
                    attrs: {
                    ...
                    domProps: { value: _vm.event.from },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.event, "from", $event.target.value)
                      }
                    }
                  })
                ]),
                ...
                _c("div", { staticClass: "col" }, [
                  ...
                  _c("input", {
                    ...
                    domProps: { value: _vm.event.to },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.event, "to", $event.target.value)
                      }
                    }
                  })
                ])
  ...
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        ...
        _vm._v(" "),
        _c("th", { attrs: { scope: "col" } }, [_vm._v("Datum")]),
        _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-70c73b48", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/admin/Events/Events.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-70c73b48", Component.options)
  } else {
    hotAPI.reload("data-v-70c73b48", Component.options)
  }
